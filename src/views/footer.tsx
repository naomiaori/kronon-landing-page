...
const Footer = () => {
    return (
        <section
            className="h-screen px-[6.5rem] py-[5.56rem]"
        >
            <div
                style={{
            ...
            >
                <div className="flex justify-between">
                    <h3 className="text-7xl font-light text-gray-300 w-[47rem]">
                        HARNESSING<br/>
                        <span className="text-white">THE POWER OF DATA</span><br/>
                        AND INNOVATION TO TRANSFORM MARKETS.
                    </h3>
                    <div>
                        <ArrowLink textSize="text-[2.625rem]" iconSize={30} href={""}>JOIN US</ArrowLink>
                        <ArrowLink textSize="text-[2.625rem]" opacity="opacity-70" iconSize={30} href={""}>JOIN US</ArrowLink>
                        <ArrowLink textSize="text-[2.625rem]" opacity="opacity-40" iconSize={30} href={""}>JOIN US</ArrowLink>
                        <ArrowLink textSize="text-[2.625rem]" opacity="opacity-20" iconSize={30} href={""}>JOIN US</ArrowLink>
                        <ArrowLink textSize="text-[2.625rem]" opacity="opacity-10" iconSize={30} href={""}>JOIN US</ArrowLink>
                        <ArrowLink textSize="text-[2.625rem]" opacity="opacity-5" iconSize={30} href={""}>JOIN US</ArrowLink>
                    </div>
                </div>
